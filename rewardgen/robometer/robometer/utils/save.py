...
from rewardgen.robometer.robometer.utils.distributed import is_rank_0
from rewardgen.robometer.robometer.utils.logger import loguru_logger as logger
...
def load_model_from_hf(
    ...
    _ConfigSafeLoader.add_constructor(
        "tag:yaml.org,2002:python/object:rewardgen.robometer.robometer.models.rewind_transformer.ReWINDTransformerConfig",
    ...
    from rewardgen.robometer.robometer.utils.setup_utils import setup_model_and_processor
